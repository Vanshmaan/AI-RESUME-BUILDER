...
const ResumeBuilder = () => {
    ...
    const loadExistingResume = async () => {
        ...
        if (resume) {
            ...
            document.title = `${resume.title} - AI Resume Builder`
        }
    }
                ...
                <div className="grid lg:grid-cols-12 gap-8">
                    ...
                    <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
                            ...
                            <button className="mt-6 px-6 py-2 text-sm text-green-600 bg-gradient-to-br from-green-100 to-green-200 rounded-md ring-1 ring-green-300 hover:ring-green-400 transition-all">
    Save Changes
</button>
                        </div>
                    ...
                    <div className="lg:col-span-7 max-lg:mt-6">
                        ...
                        <div className="relative w-full">
                            <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                                ...
                                <button onClick={downloadResume} className="flex items-center py-2 px-4 gap-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 rounded-lg ring-green-300 hover:ring transition-colors">
