...
const ExperienceForm = ({ data, onChange }) => {
    ...
    const updateExperience = (index, updatedField, value) => {
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                ...
                                <input
                                    ...
                                    className="px-3 py-2 text-sm rounded-lg border border-gray-300 outline-none focus:ring-2 focus:ring-blue-500"
                                ...
                                <input
                                    type="month"
                                    className="px-3 py-2 text-sm rounded-lg border border-gray-300 outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea value={experience.description || ""} onChange={(e) => updateExperience(index,"description",e.target.value)} rows={4}  className="w-full text-sm px-3py-2 rounded-lg resize-none " placeholder="Describe your key responsibilities and achievements..."></textarea>
                            </div>
